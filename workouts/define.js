$(function() {
	$.extend(WorkoutLog, {			//extend basically merges objects together
		definition: {
			userDefinitions: [],
			...
			create: function() {
				...
				define.done(function(data) {
					WorkoutLog.definition.userDefinitions.push(data.definition);	//.push is pushing the information into an array
					$("#def-description").val("");
					$("#def-logtype").val("");
					$('a[href="#log"]').tab("show");

					// $('a[href="#log"]').tab("show");		//module 21 wants to add this twice?
